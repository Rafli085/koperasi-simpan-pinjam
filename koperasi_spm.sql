...
--
-- Host: localhost:3306
-- Generation Time: Jan 13, 2026 at 02:51 PM
...
(6, 'gg', 'vv', 'announcement', '2025-12-29 10:47:54', NULL, 1),
(7, 'TOUR MOBA', '5 VS 5', 'poll', '2026-01-13 11:47:03', '2026-01-20 17:00:00', 1);
...
INSERT INTO `pengajuan_pinjaman` (`id`, `user_id`, `produk_id`, `jumlah`, `tenor`, `keperluan`, `status`, `catatan_admin`, `catatan_ketua`, `tanggal_pengajuan`, `tanggal_diproses`, `tanggal_approval`, `diproses_oleh`, `disetujui_oleh`, `merk_hp`, `model_hp`, `harga_hp`) VALUES
(20, 4, 2, 2000000.00, 3, 'Pinjaman Flexi', 'disetujui', NULL, NULL, '2026-01-13 12:37:14', NULL, NULL, NULL, NULL, '', '', 0.00);
...
(34, 20, 4, 2, 'pinjaman_tunai', 2000000.00, 3, 12.00, 'tahun', 'aktif', '2026-01-13 12:38:04', NULL);
...
(3, 'Beli HP', 'jual_hp', 12.00, 'tahun', 10, 1);
...
(6, 'tes', 'PMS-26-01-0001', 'tester', '123', 'anggota', '2026-01-13 10:56:55', NULL, 1);
